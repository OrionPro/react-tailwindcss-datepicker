...
const Footer = () => {
    // Contexts
    const { hideDatepicker, period, changeDatepickerValue, configs, classNames, input } = require$$0.useContext(DatepickerContext);
    // Functions
    const getClassName = require$$0.useCallback(() => {
...
const Input = () => {
    // Context
    const { primaryColor, period, dayHover, changeDayHover, calendarContainer, arrowContainer, inputText, changeInputText, hideDatepicker, changeDatepickerValue, asSingle, placeholder, separator, disabled, inputClassName, toggleClassName, toggleIcon, readOnly, startTime, endTime, displayFormat, inputId, inputName, classNames, popoverDirection, required, input, setInput } = require$$0.useContext(DatepickerContext);
    // UseRefs
...
const ItemTemplate = require$$0.memo((props) => {
    const { primaryColor, period, changePeriod, updateFirstDate, dayHover, changeDayHover, hideDatepicker, changeDatepickerValue, input } = require$$0.useContext(DatepickerContext);
    // Functions
    const getClassName = require$$0.useCallback(() => {
...
const Datepicker = (props) => {
    ...
    const [input, setInput] = require$$0.useState(null);
    // Custom Hooks use
